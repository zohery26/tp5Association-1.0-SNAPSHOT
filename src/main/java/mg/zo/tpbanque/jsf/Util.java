...
public class Util {
   ...
   * "form", clientId est "form:input". On peut aussi le trouver en examinant le
  ...
  /**
   * Message de sévérité FacesMessage.SEVERITY_ERROR qui n'est pas attaché à un
   * composant particulier. On peut donner un message différente pour le message
   * détaillé et pour le message résumé.
   *
   * @param messageDetail
   * @param messageResume
   */
